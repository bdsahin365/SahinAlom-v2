...
import { DataFetchError, EmptyStateDisplay } from '../ErrorDisplay';
...
export default function ProductsTab() {
  ...
  if (error) {
    return <DataFetchError error={error} onRetry={() => setError(null)} />;
  }
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <EmptyStateDisplay
          ...
          message={search ? 'Try a different search term' : 'Create your first product to get started'}
